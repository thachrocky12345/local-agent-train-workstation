...
- [tts-onnx](#tts-onnx)
  ...
  - [Usage: Chatterbox](#usage-chatterbox)
    ...
    - [3. Create the `args` obj](#3-create-the-args-obj)
      - [Reference Audio Guidelines](#reference-audio-guidelines)
  ...
  - [Output Format](#output-format)
    - [Output Events](#output-events)
      - [1. Audio Output Events](#1-audio-output-events)
      - [2. Job Completion Events](#2-job-completion-events)
...
*   **Base ONNX Addon:** [https://github.com/tetherto/qvac/tree/main/packages/onnx](https://github.com/tetherto/qvac/tree/main/packages/onnx)
