...
Updated the vcpkg.json addon-cpp version constraint from `>= 0.12.2` to match the actual 1.x API usage (AddonJs, JsInterface, OutputCallBackJs). Also deduplicated the lint-cpp entry and bumped it to `>= 1.4.4`.
